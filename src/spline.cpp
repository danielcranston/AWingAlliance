...
void Spline::Update(glm::vec3 p_start, glm::vec3 dir_start, glm::vec3 p_end, glm::vec3 dir_end)
{
    ...
    glm::mat4 P = { p0.x, p0.y, p0.z, 1.0, p1.x, p1.y, p1.z, 1.0,
                    p2.x, p2.y, p2.z, 1.0, p3.x, p3.y, p3.z, 1.0 };

    glm::mat4 M = { -0.5, 3 / 2.0, -3 / 2.0, 0.5, 1.0, -5 / 2.0, 2,   -0.5,
                    -0.5, 0.0,     0.5,      0,   0.0, 1.0,      0.0, 0.0 };

    glm::mat4 Mp = { 0.0, 0.0,  0.0, 0.0,  -3 / 2.0, 9 / 2.0, -9 / 2.0, 3 / 2.0,
...
//     glm::value_ptr(camprojMatrix)); glBindVertexArray(vao); glBindTexture(GL_TEXTURE_2D, 0);
